...
class LensDesignItem(models.Model):
    ...
    retail_price = models.DecimalField(max_digits=8, decimal_places=2)
    promo_price = models.DecimalField(max_digits=8, decimal_places=2)
    lens_type_retail_price = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    lens_type_promo_price = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    lens_material_retail_price = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    lens_material_promo_price = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    lens_add_on_retail_price = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    lens_add_on_promo_price = models.DecimalField(max_digits=8, decimal_places=2, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
